...
/**
 * @brief Displays the USB logo and a "Starting..." animation on the ST7789 screen.
 *
 * This function draws a USB logo at specified coordinates on the ST7789 screen and then
 * animates the text "Starting..." with dots appearing one by one in a loop. The animation
 * runs for three complete cycles (12 states total).
 *
...
/**
 * @brief Displays the main screen the ST7789 screen.
 *
